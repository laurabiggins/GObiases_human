...
chr_list = "/bi/home/bigginsl/useful_files/chr_list_human_no_mt.txt"
gtf_file = "/bi/home/bigginsl/useful_files/Homo_sapiens.GRCh38.99.gtf"
biotype = "any"
...
# had to change from a list of tuples as these are immutable and I wanted to include the distance from the between the random position and the gene
